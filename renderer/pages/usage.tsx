...
import SimpleMonthlyLineCharts from '../components/charts/SimpleMonthlyLineCharts'
          ...
          <ChartCard>
            <ChartCardTitle>
              <FlexView style={{ flexDirection:'column', alignItems: 'flex-start', }}>
                <span><FontAwesomeIcon icon={faCashRegister} /> Usage development during the year </span>
              </FlexView>
            </ChartCardTitle>
